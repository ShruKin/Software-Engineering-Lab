...
$query0 = "select * from cart, train where session='" . $_SESSION['cart'] . "' and cart.pid=train.tid and qty>0";
...
<body>
  ...
  <form action="./pay/payment.php" method="POST">
    <table>
      ...
      <input type="hidden" name="surl" value="http://localhost/railway/pay/success.php">
      <input type="hidden" name="furl" value="http://localhost/railway/pay/failure.php">
      <tr>
