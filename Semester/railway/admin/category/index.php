...
if (isset($_REQUEST["del"])) {
  $query = "delete from category where cid='" . $_REQUEST["del"] . "'";
  $result = mysqli_query($con, $query);
  header("location:index.php");
}

if (isset($_REQUEST["active"])) {
  $query = "update category set active='" . $_REQUEST['active'] . "' where cid='" . $_REQUEST["id"] . "'";
  $result = mysqli_query($con, $query);
  header("location:index.php");
  ...
  <table>
    ...
    <?php while ($fetch = mysqli_fetch_object($result)) { ?>
      <tr>
        ...
        <td><a href="index.php?del=<?php echo $fetch->cid ?>">Delete</a></td>
      </tr>
    <?php } ?>
  </table>
</body>
