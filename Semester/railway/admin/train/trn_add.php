  ...
  <form method="POST" action="" enctype="multipart/form-data">
    <table>
        ...
        <td>
          <select name="startStn" id="startStn">
            <?php while ($fetch = mysqli_fetch_object($stations)) { ?>
              <option value="<?php echo $fetch->sid ?>"><?php echo $fetch->scode ?> - <?php echo $fetch->sname ?></option>
            <?php } ?>
          </select>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td><input type="number" name="startTime" id="startTime"></td>
      </tr>
      <tr>
        <td><label for="travelTime">Travel Time</label></td>
        <td>:</td>
        <td><input type="number" name="travelTime" id="travelTime"></td>
      </tr>
      <tr>
