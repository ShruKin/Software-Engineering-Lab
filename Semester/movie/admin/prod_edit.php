...
if (isset($_POST['click'])) {
  ...
  $query = "update prod set name='" . $_POST['name'] . "', image='" . $name . "', cid='" . $_POST['cid'] . "',TA='" . $_POST['TA'] . "', price='" . $_POST['price'] . "' where pid='" . $_REQUEST['id'] . "'";
  $result = mysqli_query($con, $query);
...
<body>
  ...
  <form method="POST" action="" enctype="multipart/form-data">
    <table>
    <tr>
        <td><label for="name">Available Ticket</label></td>
        <td>:</td>
        <td><input type="number" name="TA" id="TA" value="<?php echo $fetch->TA ?>"></td>
      </tr>
      <tr>
