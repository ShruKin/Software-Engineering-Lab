...
$query0 = "select * from cart, room where session='" . $_SESSION['cart'] . "' and cart.pid=room.rid and qty>0";
...
<body>
  ...
  <form action="./pay/payment.php" method="POST">
    <table>
      ...
      <input type="hidden" name="surl" value="http://localhost/hotelsystem/pay/success.php">
      <input type="hidden" name="furl" value="http://localhost/hotelsystem/pay/failure.php">
      <tr>
